...
//	}
	...
	// Tại sao lại có biến :boolean existIsActive
	// Đâu phải entity nào cũng có thuộc tính isActive (vd History thì không
	// có isActive nên là mình sẽ thêm biên existIsActive vô để xd
	public List<EntityType> findAll(Class<EntityType> clazz, boolean existIsActive) {
		// Cái này là mình lấy Class name tùy vào đối tượng mình truyền vào(vd User,
		// Video, History,...)
		String entityName = clazz.getSimpleName();

		// Cai StringBuilder thì ai cũng biết là class in Java để nối chuỗi nha
		StringBuilder sql = new StringBuilder();

		// Ví dụ: SELECT o FROM entity o WHERE isActive = 1;
	...
	// pageSize là số lượng phần tử trong một page
